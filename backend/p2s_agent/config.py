...
class Settings(BaseSettings):
    ...
    # ``extra="ignore"`` tolerates web-only .env keys (HOST/PORT) that now belong
    # to app.config.WebSettings — without it, removing the host/port fields here
    # would make Settings() reject those keys at import (extra_forbidden).
    model_config = {
        "env_file": ".env",

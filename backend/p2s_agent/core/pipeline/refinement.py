...
from p2s_agent.core.pipeline.revision import PatchOp, RevisionPatch
from p2s_agent.core.pipeline.scoring import _evaluate_dsl, _metric_render_size
...
def run_dsl_refinement_loop(
    ...
    *,
    ...
    from p2s_agent.core.dsl.compiler import compile_dsl
    from p2s_agent.core.dsl.validator import validate_dsl as _validate_dsl
    ...
    for i in range(max_iterations):
        ...
        if current_render_path is not None:
            try:
                from p2s_agent.core.metrics.compute import grid_color_report

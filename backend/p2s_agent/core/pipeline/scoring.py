...
from p2s_agent.core.metrics.compute import compute_objective_metrics, hex_to_rgb01
from p2s_agent.core.pipeline.pool import CandidateRecord, _candidate_detail
from p2s_agent.core.metrics.quality_router import route
from p2s_agent.core.pipeline.artifacts import save_json

try:
    from p2s_agent.core.render.browser_render import render_multiple_frames
except ImportError:

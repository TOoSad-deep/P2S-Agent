...
Constraints:
- Reuses ``_load_rgba_array`` / ``_match_size_array`` from p2s_agent.core.metrics.compute.
...
from p2s_agent.core.metrics.compute import _load_rgba_array, _match_size_array
from p2s_agent.core.pipeline.region_types import FusionRegion

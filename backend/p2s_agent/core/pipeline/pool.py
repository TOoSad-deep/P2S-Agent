...
from p2s_agent.core.candidates.llm_scene import Implementation, generate_llm_scene_candidate
...
from p2s_agent.core.render.shader_validator import validate_shader

# CV candidate — may not be available during test runs
try:
    from p2s_agent.core.candidates.cv import generate_cv_candidate
    _CV_AVAILABLE = True
except ImportError:
    _CV_AVAILABLE = False

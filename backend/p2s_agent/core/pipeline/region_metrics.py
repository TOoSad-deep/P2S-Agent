...
- stdlib + numpy + PIL only (reuses helpers from p2s_agent.core.metrics.compute).
...
from p2s_agent.core.metrics.compute import (
    _load_rgba_array,
    _match_size_array,
    _composite_over,
    _gray,
...
from p2s_agent.core.pipeline.region_types import RegionConstraint
